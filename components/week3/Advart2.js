    ...
    return (
        <View style={{ padding: 1 }}>
            ...
            <View style={{ flexDirection: "row", padding: 10 }}>
                <Image style={{ width: 50, height: 50, borderRadius: 50 / 2 ,}} source={require("../../assets/week3/jaden.jpg")} />
                <View style={{ paddingLeft: 10 }}>
                    <Text style={{ fontSize: 20 }}>Yuki Jaden</Text>
                    <Text style={{ color: "gray" }}>7 hours ago | 5k views</Text>
                </View>
            </View>
            {/* View ก้อนที่ 2 */}
            <View style={{ flexDirection: "row" }}>
                <Image style={{ flex: 1, resizeMode: "cover", aspectRatio: 4 / 2 ,borderRadius : 20 }} source={require("../../assets/week3/deck2.webp")} />
            </View>
            {/* View ก้อนที่ 3 */}
            <View style={{ padding: 10 }}>
                <Text style={{ color: '#444444' }}>Hero's Decks Hope you enjoy the game gotcha!!!!. </Text>
                {/* view ก้อนที่ 4 */}
